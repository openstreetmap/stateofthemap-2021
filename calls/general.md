...
<h3 id="track-experiences" class="trackicon">Art & Creativity</h3>
...
The conference language of State of the Map is English. All presentations shall be held in English. It is an important aspect of the conference that participants can interact with the speaker for questions and discussion.
Non-English participants are welcome to meet in Bird of Feather sessions (BoF).
...
* 5 May 2021: Deadline [academic talk submissions]({{site.baseurl}}/calls/academic)
